...
public class DistClient implements Watcher, AsyncCallback.StatCallback, AsyncCallback.DataCallback {
	...
	// , UnknownHostException
		...
		this.taskNodeName = zk.create("/dist31/tasks/task-", dTaskSerial, Ids.OPEN_ACL_UNSAFE,
				CreateMode.PERSISTENT_SEQUENTIAL);
		// taskNodeName = zk.create("/dist31/tasks/task-", pinfo.getBytes(),
	...
	public void processResult(int rc, String path, Object ctx, byte[] data, Stat stat) {
		...
		// System.out.println("DISTAPP : processResult : DataCallback : " + rc + ":" +
		// path + ":" + ctx + ":" + new String(data==null?"null".getBytes():data) + ":"
		// + stat);
	...
	public static void main(String args[]) throws Exception {
		// You can accept the number of samples to be used for computing Pi from the
		// command argument.
